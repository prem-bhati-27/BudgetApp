...
const SECTIONS: Section[] = [
  {
    ...
    illustration: { icons: [
      { name: 'plus-circle', bg: '#20C4B822', color: '#20C4B8' },
      { name: 'dollar-sign', bg: '#2BD49B22', color: '#2BD49B' },
      { name: 'check-circle', bg: '#8B7CF822', color: '#8B7CF8' },
    ] },
    items: [
      ...
      { icon: 'list', color: '#FB923C', title: 'Itemized bills', body: 'For restaurant bills or groceries with multiple items: Tap + \u2192 Itemized Bill. Add each item with quantity and price, assign items to people, add tax/tip, then review the per-person breakdown before saving.' },
  ...
  },
  {
    ...
    illustration: { icons: [
      { name: 'users', bg: '#FF6F6122', color: '#FF6F61' },
      { name: 'scissors', bg: '#20C4B822', color: '#20C4B8' },
      { name: 'check', bg: '#2BD49B22', color: '#2BD49B' },
    ] },
    items: [
      { icon: 'users', color: '#FF6F61', title: 'Creating a group', body: 'Go to Groups tab \u2192 tap "New Group". Give it a name (e.g. "Me & GF", "Flatmates"), pick an icon and color, then add members. Your "Personal" group is always private \u2014 just you.' },
      ...
      { icon: 'credit-card', color: '#F5B301', title: 'Multiple payers', body: 'If more than one person paid for something, tap "Who paid?" and enter each person\'s contribution. The app ensures total paid equals total shared \u2014 save is blocked until balanced.' },
      { icon: 'alert-circle', color: '#FF5C5C', title: 'The balance rule', body: 'Every transaction must balance: total paid = total shared. If there\'s a mismatch, you\'ll see "\u20b9X unassigned" in red and the save button stays disabled. This prevents errors.' },
      ...
      { icon: 'archive', color: '#8B7CF8', title: 'Archiving groups', body: 'Swipe left on any group to archive it, or use the filter chips (Active/Archived) at the top. Archived groups keep all data but are hidden from your main view. Tap to restore anytime.' },
      { icon: 'droplet', color: '#FB923C', title: 'Group theming', body: 'Each group gets a subtle color gradient header matching its chosen color. The tab underline and icon also reflect the group\'s identity for quick visual recognition.' },
    ],
  },
  {
  ...
  },
  {
    ...
    illustration: { icons: [
      { name: 'repeat', bg: '#20C4B822', color: '#20C4B8' },
      { name: 'calendar', bg: '#8B7CF822', color: '#8B7CF8' },
      { name: 'pause-circle', bg: '#F5B30122', color: '#F5B301' },
    ] },
    items: [
      ...
      { icon: 'pause-circle', color: '#F5B301', title: 'Pause, resume & end', body: 'Go to a group \u2192 Recurring tab to see all active schedules. You can Pause (temporarily stop), Resume, or End any recurring rule. Past instances remain in your history.' },
  ...
  },
  {
    ...
    illustration: { icons: [
      { name: 'pie-chart', bg: '#FF6F6122', color: '#FF6F61' },
      { name: 'download', bg: '#20C4B822', color: '#20C4B8' },
      { name: 'file-text', bg: '#8B7CF822', color: '#8B7CF8' },
    ] },
    items: [
      ...
      { icon: 'pie-chart', color: '#FF6F61', title: 'Charts', body: 'See spending by category (donut chart) and 6-month spending trend (bar chart). On the dashboard, tap chart points to see exact values at that moment.' },
      { icon: 'trending-up', color: '#8B7CF8', title: 'Spending forecast', body: 'For the current month, a line chart shows your daily cumulative spending plus a projected trend line to month-end. The forecast badge shows estimated total spend if you maintain this pace.' },
      { icon: 'award', color: '#F5B301', title: 'Year in review', body: 'At the bottom of Reports: total income, total spent, total saved for the year \u2014 plus your top category and biggest single expense. A quick yearly health check.' },
  ...
  },
  {
    title: 'Categories',
    illustration: { icons: [
      { name: 'tag', bg: '#2BD49B22', color: '#2BD49B' },
      { name: 'grid', bg: '#FB923C22', color: '#FB923C' },
      { name: 'plus', bg: '#20C4B822', color: '#20C4B8' },
    ] },
    items: [
      { icon: 'grid', color: '#FB923C', title: 'Expense categories', body: '33 categories across 8 sections: Home & Living, Food, Transport, Bills & Utilities, Lifestyle, Health, Money & Growth, and Other. Each has a unique icon and color.' },
  ...
  },
  {
    ...
    illustration: { icons: [
      { name: 'lock', bg: '#20C4B822', color: '#20C4B8' },
      { name: 'eye-off', bg: '#8B7CF822', color: '#8B7CF8' },
      { name: 'shield', bg: '#2BD49B22', color: '#2BD49B' },
    ] },
    items: [
      ...
      { icon: 'map-pin', color: '#F5B301', title: 'Location tagging', body: 'Optionally tag transactions with where you made them. OFF by default, explicitly enable in Settings. Location data never leaves your device.' },
  ...
  },
  {
    title: 'Dashboard',
    illustration: { icons: [
      { name: 'home', bg: '#20C4B822', color: '#20C4B8' },
      { name: 'trending-up', bg: '#2BD49B22', color: '#2BD49B' },
      { name: 'layers', bg: '#FF6F6122', color: '#FF6F61' },
    ] },
    items: [
      ...
      { icon: 'pie-chart', color: '#FF6F61', title: 'Spending by category', body: 'The donut chart breaks down spending visually. Tap a segment to focus. The legend shows percentage and rupee amount for each category.' },
      ...
      { icon: 'credit-card', color: '#F5B301', title: 'Owe / Owed', body: 'Total balance across all groups at a glance. Tap to go to global Settle Up where you can see and record payments.' },
  ...
  },
  {
    title: 'Tips & Tricks',
    illustration: { icons: [
      { name: 'star', bg: '#F5B30122', color: '#F5B301' },
      { name: 'hash', bg: '#FB923C22', color: '#FB923C' },
      { name: 'clock', bg: '#8B7CF822', color: '#8B7CF8' },
    ] },
    items: [
      ...
      { icon: 'calendar', color: '#F5B301', title: 'Any date', body: 'Transactions aren\'t limited to today. Set any past or future date. Backdate a forgotten expense or pre-record a known payment.' },
